...
void writeTest(void)
{
  ...
  {
   // i2c_eeprom.write(address, address/1024);//0x50
	i2c_eeprom.write(address, 0x55);//0x50
    if ((address%1024) == 0) 
	{
