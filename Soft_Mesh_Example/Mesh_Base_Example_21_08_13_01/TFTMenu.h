...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
class TFTPasswordScreen : public AbstractTFTScreen
{
public:
...
private:
  ...
  TFT_Buttons_Rus* screenButtons; 
  String enteredPass, ethalonPass;
  int textBox;
  int lastKeyButtonID;
  int backButton, clearButton;
...
private:
  ...
  int cal_0_Button, cal_209_Button, measureTimeButton, calibrationTimeButton, backButton;
  TFT_Buttons_Rus* screenButtons; 
